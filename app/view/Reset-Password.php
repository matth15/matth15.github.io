  ...
  <div class="wrapper">
    <div class="container shadow bg-light rounded-3">
      <div class="row">
        ...
        <form action="<?= baseurl() ?>/account/reset_password" method="POST">
          ...
          <div class="col-12 p-2">
            <div class="form-group col-12">
              ...
              <input type="password" class="form-control rounded-0" name="n_pass" id="newPasswordInput">
            </div>
            <div class="form-group col-12">
              <label for="confirmPasswordInput" class="form-label">Confirm new password</label>
              <input type="password" class="form-control rounded-0" name="n_cpass" id="confirmPasswordInput">
            </div>
