...
class Session
{
    ...
    public static function danger($msg)
    {
        if (isset($_SESSION[$msg])) {
            ...
            echo '<div class="alert alert-danger rounded-2 d-flex justify-content-center ">' . $_SESSION[$msg] . '</div>';
    ...
    public static function warning($msg)
    {
        if (isset($_SESSION[$msg])) {
            ...
            echo '<div class="alert alert-warning rounded-2 d-flex justify-content-center ">' . $_SESSION[$msg] . '</div>';
